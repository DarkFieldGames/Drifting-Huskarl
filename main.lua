...
function love.load()
   ...
   printbars = love.graphics.newImage("text/bars.png")
   printdecompression = love.graphics.newImage("text/decompression.png")
   printloading = love.graphics.newImage("text/loading.png")
   printoxygen = love.graphics.newImage("text/oxygen.png")
   printradiation = love.graphics.newImage("text/radiation.png")
   printstarvation = love.graphics.newImage("text/starvation.png")
   printwin = love.graphics.newImage("text/win.png")
...
--	end
	...
	love.graphics.draw(printbars,746,6,0,1,1)
...
--	love.graphics.print("Energy:",746,12*7)
	...
	if life.dead ~= 0 then
		...
		if life.dead == 99 then
			love.graphics.draw(printwin,312,350,0,1,1)
	...
	if loadcheck then
		love.graphics.draw(printloading,312,470,0,1,1)
...
function love.mousereleased(x, y, button)
	if mainmenu then
		if button == 'l' then
			...
			if y > 393+28+28 and y < 393+28+28+28 then love.event.quit() end
		end
	end
end
